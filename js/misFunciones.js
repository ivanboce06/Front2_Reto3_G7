...
function guardarInformacionCategorias(){
    let var2 = {
        ...
        url:"http://129.151.116.233:8080/api/Category/save",
...
function traerInformacionMotorbike(){
    $.ajax({
        url:"http://129.151.116.233/api/Motorbike/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function traerInformacionClientes(){
    $.ajax({
        url:"http://129.151.116.233:8080/api/Client/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
            console.log(respuesta);
...
function guardarInformacionClientes(){
    let var4 = {
        ...
        url:"http://129.151.116.233:8080/api/Client/save",
